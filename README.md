...
Veja também [`docs/init-system-alternatives.md`](./docs/init-system-alternatives.md) — avaliação de se trocar de init system (systemd → runit/dinit/OpenRC via Artix ou Void) reduz essa classe de risco. Resposta curta: não elimina, só muda de fornecedor, e o custo de migração costuma não compensar para uso pessoal de desktop.
